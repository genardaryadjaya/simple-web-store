-- Database setup untuk Hosting (InfinityFree, dll.)
-- Jalankan file ini di phpMyAdmin setelah Anda memilih database dari control panel.
-- File ini tidak berisi perintah CREATE DATABASE.
